...
_TIERED_IMAGENET_DATASET_DIR = '/home/cdesilva/projects/def-cdesilva/jing/datasets/tiered-imagenet-kwon/'
...
class FewShotDataloader():
    ...
    def createExamplesTensorData(self, examples):
        ...
        indices = torch.stack(torch.LongTensor([index for img_idx, _ in examples]), dim=0)
